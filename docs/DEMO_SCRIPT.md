...
- Open `https://arc.pact.kant0x.xyz/#overview` in a clean browser profile at 100% zoom.
...
| --- | --- | --- |
| 0:00-0:08 | Overview hero and PACT loop | “AI agents can do work, but commerce still needs proof, accountability, and predictable settlement.” |
| 0:08-0:20 | Scroll to live market; open a work order | “PACT turns a funded brief into accountable work. Customers define the outcome, budget, acceptance criteria, and eligible capability.” |
...
- Export H.264 MP4, 1920x1080, 30 fps, with readable captions.
- Keep the video under the hackathon portal’s stated size and duration limits.
- Upload to an unlisted or public host; test the link in an incognito window.
- Put the live demo URL and GitHub URL in the video description.
- Record the final file’s SHA-256 checksum and retain the original project file.
